package io.github.CursoSpringBootUdemy.libraryapi.config;
        ...
        return context -> {
            ...
            if(principal instanceof CustomAuthentication authentication) {
                ...
                if(OAuth2TokenType.ACCESS_TOKEN.equals(tipoToken)) {
                    ...
                    List<String> listaAuthorities = authorities.stream().map(GrantedAuthority::getAuthority).toList();
                    context
                            .getClaims()
                            .claim("authorities", listaAuthorities)
